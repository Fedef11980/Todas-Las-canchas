...
const cargarProductos = (respuesta) => {
  ...
  productos.forEach((producto, indice) => {
    ...
    let html = `<div class="card-group">
        <img src=${producto.imagen} class="card-img-top tarjeta" alt="Camisetas de Basketball">
          <div class="card-body">
  ...
  if (cart.length > 0) {
    cart.forEach((producto, indice) => {
      ...
      carritoContainer.innerHTML = `
          ...
          id="remove-product" onClick="removeProduct(${indice})">Eliminar producto</button>`;
    ...
    <button class= "btn btn-warning finalizar" id="finalizar" onClick="finalizarCompra()"> 
